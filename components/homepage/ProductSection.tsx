  ...
  const products = [
    {
      ...
      link: "/product-category/google-play",
    },
    {
      id: 2,
      alt: "iTunes Gift Card",
      url: "/products/itunes.png",
      link: "/product-category/app-store-i-tunes-gift-cards",
    },
    {
      id: 3,
      alt: "Razer Gold Gift Card",
      url: "/products/razer.png",
      link: "/product-category/razer-gold",
    },
    {
      id: 4,
      alt: "PlayStation Gift Card",
      url: "/products/playstation.png",
      link: "/product-category/playstation",
    },
    {
      id: 5,
      alt: "Xbox Gift Card",
      url: "/products/xbox.png",
      link: "/product-category/xbox-gift-card",
    },
    {
      id: 8,
      alt: "Steam Gift Card",
      url: "/products/steam.png",
      link: "/product-category/steam-gift-card",
    },
    {
      id: 6,
      alt: "PubG Gift Card",
      url: "/products/pubg.png",
      link: "/product-category/pubg-gift-cards",
    },
    {
      id: 7,
      alt: "Amazon Gift Card",
      url: "/products/amazon.png",
      link: "/product-category/amazon-gift-cards",
    },
  ];
  return (
