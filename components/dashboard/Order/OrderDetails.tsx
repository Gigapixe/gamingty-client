      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#111] p-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 w-full lg:w-auto">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 h-10 rounded-full border border-emerald-500 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-[#0f1a14] w-full lg:w-auto"
          >
            <IoKeyOutline />
