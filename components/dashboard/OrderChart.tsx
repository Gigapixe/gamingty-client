...
const OrderChart: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-background-dark p-5 rounded-2xl border border-gray-200 dark:border-[#303030]">
      ...
      {/* Body */}
      {loading ? (
        <div className="mt-4 h-90 w-full rounded-xl bg-gray-50 dark:bg-gray-800 animate-pulse border border-gray-200 dark:border-[#303030]" />
      ) : error ? (
        ...
        <div className="mt-4 p-6 rounded-xl border border-gray-200 dark:border-[#303030] text-sm text-gray-600 dark:text-gray-300">
          No overview data found for this range.
        </div>
      ) : (
