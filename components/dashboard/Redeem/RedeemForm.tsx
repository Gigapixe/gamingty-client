...
export default function RedeemForm({
  ...
  return (
    <form onSubmit={onSubmit}>
      <label
        htmlFor="code"
        className="block text-base font-medium text-[#6B7280] dark:text-[#E5E5E5] mb-2"
      >
        ...
        >
          {previewLoading ? (
            ...
            <>
              ...
              <span className="text-sm font-medium">Get Preview & Redeem</span>
            </>
          )}
        </button>
